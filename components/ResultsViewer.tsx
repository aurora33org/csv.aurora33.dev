    ...
    <div className="w-full max-w-3xl mx-auto">
      <div className="card">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div className="bg-card p-4 border border-primary">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-sm text-muted-foreground font-medium">Archivos</p>
          ...
          <div className="bg-card p-4 border border-primary">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-sm text-muted-foreground font-medium">Tamaño total</p>
          ...
          <div className="bg-card p-4 border border-primary">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-foreground">{formatFileSize(totalSize / files.length)}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Lista de archivos */}
        <div className="mb-6">
          <h3 className="text-lg font-semibold text-foreground mb-3">Archivos generados:</h3>
          <div className="space-y-2 max-h-96 overflow-y-auto">
            {files.map((file, index) => (
              <div
                key={index}
                className="flex items-center justify-between p-4 bg-card hover:bg-secondary transition-colors border border-border"
              >
                ...
                <button
                  ...
                  className="ml-4 px-4 py-2 bg-primary text-primary-foreground hover:opacity-90 transition-opacity flex items-center space-x-2 flex-shrink-0"
                >
