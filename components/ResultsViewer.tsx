      ...
      <div className="card">
        ...
        <div className="mb-6 text-center">
          ...
          <p className="text-slate-600">
            ...
            <span className="font-semibold text-primary-600">{files.length}</span>{' '}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-4 border border-blue-200">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-sm text-blue-700 font-medium">Archivos</p>
          ...
          <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg p-4 border border-purple-200">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-sm text-purple-700 font-medium">Tamaño total</p>
          ...
          <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-4 border border-green-200">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-green-900">{formatFileSize(totalSize / files.length)}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Lista de archivos */}
        <div className="mb-6">
          <h3 className="text-lg font-semibold text-slate-800 mb-3">Archivos generados:</h3>
            ...
            {files.map((file, index) => (
              ...
              >
                ...
                <button
                  ...
                  className="ml-4 px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white rounded-lg transition-colors flex items-center space-x-2 flex-shrink-0"
                >
