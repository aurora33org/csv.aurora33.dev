...
export default function Home() {
  ...
  return (
    <div className="max-w-[1600px] mx-auto px-4 sm:px-8 lg:px-[60px] py-8 md:py-12">
      ...
      {cooldownError && (
        <div className="mb-6 p-5 bg-red-50 dark:bg-red-900/20 border-2 border-red-500 animate-fade-in">
        ...
        <div className="animate-fade-in">
          <div className="mb-8 md:mb-12">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-primary leading-tight">
              ...
              <br />
              <span className="text-foreground">Para cualquier proyecto.</span>
            </h1>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-foreground text-sm md:text-base">División automática por número de filas</p>
                </div>
                <div className="flex items-start space-x-3">
                  <svg className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <p className="text-foreground text-sm md:text-base">Mantén el encabezado en todos los archivos si lo necesitas</p>
                </div>
                <div className="flex items-start space-x-3">
                  <svg className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <p className="text-foreground text-sm md:text-base">100% privado - procesamiento local en tu navegador</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-wrap items-center justify-center gap-4">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-muted-foreground font-medium">100% Gratuito</span>
                </div>
                <div className="flex items-center space-x-2">
                  <svg className="w-5 h-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                  </svg>
                  <span className="text-sm text-muted-foreground font-medium">Procesamiento Seguro</span>
                </div>
                <div className="flex items-center space-x-2">
                  <svg className="w-5 h-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                  </svg>
                  <span className="text-sm text-muted-foreground font-medium">División Rápida</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div id="how-it-works" className="mt-16 md:mt-24">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-primary text-primary-foreground mb-4 text-2xl font-bold">
                1
              </div>
              <h3 className="text-xl font-semibold text-foreground mb-3">Sube tu archivo CSV</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3">Configura la división</h3>
              <p className="text-muted-foreground">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3">Descarga tus archivos</h3>
              <p className="text-muted-foreground">
      ...
      {currentStep === 'upload' && (
        <div id="features" className="mt-16 md:mt-24">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card hover:bg-secondary transition-colors">
              ...
              <h3 className="font-semibold text-foreground text-lg mb-2">Importación de bases de datos</h3>
            ...
            <div className="card hover:bg-secondary transition-colors">
              ...
              <h3 className="font-semibold text-foreground text-lg mb-2">Análisis de datos</h3>
              <p className="text-muted-foreground text-sm">
            ...
            <div className="card hover:bg-secondary transition-colors">
              ...
              <h3 className="font-semibold text-foreground text-lg mb-2">Envío por email</h3>
              <p className="text-muted-foreground text-sm">
            ...
            <div className="card hover:bg-secondary transition-colors">
              ...
              <h3 className="font-semibold text-foreground text-lg mb-2">Distribución de trabajo</h3>
              <p className="text-muted-foreground text-sm">
            ...
            <div className="card hover:bg-secondary transition-colors">
              ...
              <h3 className="font-semibold text-foreground text-lg mb-2">Respaldo de datos</h3>
              <p className="text-muted-foreground text-sm">
            ...
            <div className="card hover:bg-secondary transition-colors">
              ...
              <h3 className="font-semibold text-foreground text-lg mb-2">Testing y desarrollo</h3>
              <p className="text-muted-foreground text-sm">
